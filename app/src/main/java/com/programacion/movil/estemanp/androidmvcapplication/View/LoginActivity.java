...
import com.programacion.movil.estemanp.androidmvcapplication.Controller.Singleton;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login(View view) {
        if( Singleton.getSingleton().isValidUser(userName.getText().toString(),password.getText().toString())) {
